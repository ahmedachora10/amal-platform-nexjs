...
export default function LessonQuizBox({ title = "", unitValue, progress = 0, url = "", noProgress = false, unitName = "M" }) {
    ...
    return (
        <div className={"w-full flex flex-col gap-3 border-2 border-[#EAEAEA] rounded-lg p-4" + (url ? " hover:shadow hover:border-gray-300 transition-all cursor-pointer" : "")} onClick={url ? () => router.push(url) : undefined}>
